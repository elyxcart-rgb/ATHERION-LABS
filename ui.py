...
class OnboardingWizard(QWidget):
    ...
    def _set_theme(self, theme: str):
        ...
        self._pref_theme_dark.setChecked(theme == "dark")
        self._pref_theme_light.setChecked(theme == "light")
        self._pref_theme_scifi.setChecked(theme == "scifi")

        if theme == "scifi":
            from pyqt6_theme import apply_scifi_theme
            apply_scifi_theme()
        elif theme == "dark":
            from pyqt6_theme import restore_default_theme
    ...
    def _finish(self):
        ...
        # Collect preferences
        if self._pref_theme_scifi.isChecked():
            theme_val = "scifi"
        elif self._pref_theme_light.isChecked():
            theme_val = "light"
        else:
            theme_val = "dark"
...
class ProfileEditorOverlay(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._theme_scifi = QPushButton("\u2694 Sci-Fi Gold")
        self._theme_scifi.setCheckable(True)
        self._theme_scifi.setCursor(Qt.CursorShape.PointingHandCursor)
        self._theme_scifi.setStyleSheet(f"""
            QPushButton {{ color: {C.PRI_DIM}; background: {HU.FILL2}; border: 1px solid {C.BORDER};
                           border-radius: 4px; padding: 4px 12px; font-size: 8px; }}
            QPushButton:checked {{ color: #ffd700; background: #1a1a08; border: 1px solid #ffd700; }}
            QPushButton:hover {{ border: 1px solid #ffd700; }}
        """)
        self._theme_scifi.clicked.connect(lambda: self._set_theme("scifi"))
        theme_row.addWidget(self._theme_scifi)
    ...
    def _set_theme(self, theme: str):
        ...
        self._theme_scifi.setChecked(theme == "scifi")
        if theme == "scifi":
            from pyqt6_theme import apply_scifi_theme
            apply_scifi_theme()
        elif theme == "dark":
